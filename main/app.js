    ...
    render: function () {
        return (
            <div>
                ...
                <StockTable last={this.state.last} unwatchStockHandler={this.unwatchStock}/>
                <div className="row">
...
// var indexPage = ReactCreateClass({
//   render: function()
//   {
//     return
//     (
//       <StockTable last={this.state.last} />
//     );
//   }

// });

// React.renderComponent(<indexPage/>, document.getElementById('reactReference'));
